...
<div class="row t30">
        ...
        <img src="{{ site.urlimg }}aguirre.jpg" alt="Luis Aguirre">
        ...
        <div class="medium-4 columns">
        <img src="{{ site.urlimg }}andina.jpg" alt="Matias Andina">
        ...
        <div class="medium-4 columns">
        <img src="{{ site.urlimg }}bruce.jpg" alt="Maggie Bruce">
        ...
        <div class="medium-4 columns">
        <img src="{{ site.urlimg }}krentzel.jpg" alt="Amanda Krentzel">
        ...
        <div class="medium-4 columns">
        <img src="{{ site.urlimg }}melzer.jpg" alt="Emily S. Melzer">
        <p><a href = "{{ site.url }}/authors/emelzer"><b>Emily S. Melzer</b></a></p>
        </div>
        
        <div class="medium-4 columns">
        <img src="{{ site.urlimg }}morozov.jpg" alt="Aleksey Morozov">
